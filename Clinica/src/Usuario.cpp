...
int verificarExistenciaUsuarioRecepcionista(char usuario[80],char contrasena[80]){
	...
	FILE *file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Recepcionistas.dat","rb");
...
int verificarExistenciaUsuarioAdmin(char usuario[80],char contrasena[80]){
	...
	FILE *file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Admin.dat","rb");
...
void crearRecpcionista(){
	...
	FILE* arch = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Recepcionistas.dat","rb");
	user aux1;
...
static void insertarRecepcionista(user usuarios[], int i){
	...
	FILE *file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Recepcionistas.dat","ab");
...
static int insertarProfesional(NuevoProfesional profesional[],int ind) {
	...
	FILE *file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Profesionales.dat","ab");
