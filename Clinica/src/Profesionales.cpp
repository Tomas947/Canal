...
#include <string.h>
#include <conio.h>
#include "\Users\Equipo\Desktop\Clinica\header\Profesionales.h"
#include "\Users\Equipo\Desktop\Clinica\header\Pacientes.h"
#include "\Users\Equipo\Desktop\Clinica\header\Usuario.h"
...
void listarPacientes(){
	...
	FILE* file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Pacientes.dat","rb");
...
void listarhistorialClinico(){
	...
	FILE* file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\HistorialClinico.dat","rb");
...
void atencionesPorProfesional(){
	...
	FILE *arch = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Profesionales.dat","rb");
...
void atenderPacienteConTuno(){
	...
	FILE* file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Profesionales.dat","rb");
	NuevoProfesional profesional;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Turnos.dat","rb");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(bandera == true){// esto significa que por lo menos hay un turno registrado y recien ahi hay que hacer todo esto
		...
		file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Pacientes.dat","rb");
...
fecha fechaPaciente(int dniPaciente){
	...
	FILE *file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Turnos.dat","rb");
...
static void registarHistorialClinico(Paciente paciente,NuevoProfesional profesional){
	...
	FILE* file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\HistorialClinico.dat","ab");
...
static void eliminarTurno(Paciente paciente){
	...
	fclose(file);	
	remove("\\Users\\Equipo\\Desktop\\Clinica\\files\\Turnos.dat");
	
	i = 0;
	file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Turnos.dat","ab");
...
static void eliminarPaciente(Paciente paciente){
	...
	file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Pacientes.dat","wb");
	fclose(file);
	
	
	file = fopen("\\Users\\Equipo\\Desktop\\Clinica\\files\\Pacientes.dat","ab");
